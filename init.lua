...
local config = {
  ...
  mappings = {
    ...
    n = {
        ...
        ["<F2>"] = { "<cmd>Neotree focus<cr>", desc = "Focus Explorer" },
        ["<F4>"] = { "<cmd>set paste!<cr>", desc = "Toggle Paste mode" },
        ["<F6>"] = { "mzgg=G`z", desc = "Reindent all lines in file" },
        ["<F8>"] = { "<cmd>noh<cr>", desc = "Clear search highlights" },
        ["<F9>"] = { "<cmd>Legendary<cr>", desc = "Open Legendary popup" },
        ["<F10>"] = { "<cmd>ZenMode<cr>", desc = "Open Zen Mode" },
        -- ["<F11>"] = { "<cmd>FloatermNew<cr>", desc = "Open new floating Terminal" },
        -- ["<F12>"] = { "<cmd>FloatermToggle<cr>", desc = "Toggle floating Terminal" },
    ...
    t = {
        ["<F1>"] = { "<F1>", desc = "Toggle Explorer" },
        ["<F2>"] = { "<F2>", desc = "Focus Explorer" },
